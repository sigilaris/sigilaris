  ...
  test("derive emits descriptive error when requirement absent"):
    ...
    assert(
      clue(errors).contains(
        "Needs: org.sigilaris.core.application.domain.Entry[\"baz\", org.sigilaris.core.datatype.Utf8$package.Utf8, org.sigilaris.core.datatype.Utf8$package.Utf8]"
      )
    )
    assert(
      clue(errors).contains(
        "Schema: org.sigilaris.core.application.domain.Entry[\"foo\", org.sigilaris.core.datatype.Utf8$package.Utf8, org.sigilaris.core.datatype.Utf8$package.Utf8] *: org.sigilaris.core.application.domain.Entry[\"bar\", org.sigilaris.core.datatype.Utf8$package.Utf8, org.sigilaris.core.datatype.Utf8$package.Utf8]"
      )
    )
