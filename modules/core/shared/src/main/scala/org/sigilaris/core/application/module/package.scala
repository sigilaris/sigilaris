...
/** Module system for blockchain application architecture.
  *
  * This package provides the core abstractions for building modular blockchain
  * applications with compile-time schema validation, type-safe table access,
  * and automatic dependency injection.
  *
  * =Architecture Overview=
  *
  * The module system has two main phases:
  *   - '''Blueprint Phase''' - Path-independent module specifications
  *   - '''Runtime Phase''' - Path-bound modules with instantiated tables
  *
  * =Blueprint Types (Path-Independent)=
  *
  * '''[[org.sigilaris.core.application.module.blueprint.Blueprint]]''' - Base
  * trait for all blueprints
  *   - Covariant in reducer type
  *   - Contains Entry instances (not StateTable instances)
  *   - Declares Owns and Needs schemas
  *
  * '''[[org.sigilaris.core.application.module.blueprint.ModuleBlueprint]]''' -
  * Single module specification
  *   - Uses [[org.sigilaris.core.application.module.blueprint.StateReducer0]]
  *     (accepts any Tx)
  *   - Self-contained with owned tables and external dependencies
  *   - Can be mounted at any path
  *
  * '''[[org.sigilaris.core.application.module.blueprint.ComposedBlueprint]]'''
  * \- Combined modules
  *   - Uses
  *     [[org.sigilaris.core.application.module.blueprint.RoutedStateReducer0]]
  *     (requires ModuleRoutedTx)
  *   - Routes transactions based on moduleId.path
  *   - Created via
  *     [[org.sigilaris.core.application.module.blueprint.Blueprint.composeBlueprint]]
  *
  ...
  *
  * '''[[org.sigilaris.core.application.module.runtime.StateReducer]]''' -
  * Single module reducer
  *   - Path-bound version of StateReducer0
  *   - Accepts any transaction type T <: Tx
  *
  * '''[[org.sigilaris.core.application.module.runtime.RoutedStateReducer]]''' -
  * Composed module reducer
  ...
  *
  * '''[[org.sigilaris.core.application.module.blueprint.SchemaMapper]]''' -
  * Typeclass for table creation
  ...
  *
  * '''[[org.sigilaris.core.application.module.blueprint.SchemaInstantiation]]'''
  * \- Convenience helpers
  ...
  *
  * @example
  *   Creating a simple module blueprint:
  *   ```scala
  ...
  *   val blueprintB =
  *     new ModuleBlueprint[IO, "balances", SchemaB, SchemaA, TxsB](
  *       owns = schemaB,
  *       reducer0 = reducerB,
  *       txs = txRegistryB,
  ...
  *
  * '''Type Safety:'''
  *   - Compile-time schema validation via
  *     [[org.sigilaris.core.application.support.compiletime.Requires]]
  *   - Compile-time uniqueness checks via
  *     [[org.sigilaris.core.application.support.compiletime.UniqueNames]]
  *   - Compile-time prefix-free validation via
  *     [[org.sigilaris.core.application.support.compiletime.PrefixFreePath]]
  *
  * @see
  *   [[org.sigilaris.core.application.state]] for table and schema types
  * @see
  *   [[org.sigilaris.core.application.transactions]] for transaction types
  * @see
  *   [[org.sigilaris.core.assembly]] for high-level DSL
  */
