...
/** High-level assembly DSL for blockchain application construction.
  *
  * This package provides convenient tools and DSL methods for assembling
  * blockchain applications from modular blueprints, with compile-time
  * validation and type-safe table access.
  *
  * =Core Components=
  *
  * '''[[org.sigilaris.core.assembly.BlueprintDsl]]''' - High-level mounting DSL
  *   - `mount` - Mount
  *     [[org.sigilaris.core.application.module.blueprint.ModuleBlueprint]] at
  *     single-segment path
  *   - `mountAtPath` - Mount ModuleBlueprint at multi-segment path
  *   - `mountComposed` - Mount
  *     [[org.sigilaris.core.application.module.blueprint.ComposedBlueprint]] at
  *     single-segment path
  *   - `mountComposedAtPath` - Mount ComposedBlueprint at multi-segment path
  *   - Automatic evidence requirements (PrefixFreePath, SchemaMapper,
  *     NodeStore)
  *
  * '''[[org.sigilaris.core.assembly.EntrySyntax]]''' - String interpolator for
  * Entry creation
  *   - `entry"tableName"[K, V]` creates Entry[Name, K, V] with compile-time
  *     literal extraction
  *   - Ensures table names are string literals (not expressions)
  *   - Preserves type-level information for schema validation
  *
  * '''[[org.sigilaris.core.assembly.TablesProviderOps]]''' - Provider
  * extraction extensions
  *   - `module.toTablesProvider` - Extract
  *     [[org.sigilaris.core.application.module.provider.TablesProvider]] from
  *     mounted module
  *   - Bridges gap between module mounting and dependency injection
  *
  * '''[[org.sigilaris.core.assembly.TablesAccessOps]]''' - Evidence derivation
  * utilities
  *   - `deriveLookup[Schema, Name, K, V]` - Derive
  *     [[org.sigilaris.core.application.support.compiletime.Lookup]] evidence
  *   - `deriveRequires[Needs, Schema]` - Derive
  *     [[org.sigilaris.core.application.support.compiletime.Requires]] evidence
  *   - `provider.providedTable[Name, K, V]` - Access table with automatic
  *     evidence derivation
  *
  * '''[[org.sigilaris.core.assembly.PrefixFreeValidator]]''' - Runtime prefix
  * validation
  ...
  *
  * The assembly package is the recommended entry point for application
  * construction:
  *   - Define schemas using [[org.sigilaris.core.assembly.EntrySyntax]]
  *   - Create blueprints using
  *     [[org.sigilaris.core.application.module.blueprint]]
  *   - Mount blueprints using [[org.sigilaris.core.assembly.BlueprintDsl]]
  *   - Extract providers using
  *     [[org.sigilaris.core.assembly.TablesProviderOps]]
  *   - Wire dependencies and compose modules
  *
  * @see
  *   [[org.sigilaris.core.application.module]] for underlying module system
  * @see
  *   [[org.sigilaris.core.application.state]] for table and schema types
  * @see
  *   [[org.sigilaris.core.application.support.compiletime]] for evidence types
  */
