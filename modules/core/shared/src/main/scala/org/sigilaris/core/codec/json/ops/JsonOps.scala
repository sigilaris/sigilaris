...
/** Pure interfaces for parsing and printing JSON using backend implementations.
  *
  * These traits define backend-agnostic operations for JSON string parsing and
  * printing. Implementations (e.g., Circe) must not leak their own AST types
  * outside this package.
  *
  * @see
  *   [[org.sigilaris.core.codec.json.backend.circe.CirceJsonOps]]
  */
trait JsonParser:
  /** Parses a JSON string into a [[JsonValue]].
    ...
    *   the JSON string
    * @return
    *   either a parse failure or the parsed JSON value
    */
