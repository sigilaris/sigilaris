...
- 결과: canonical repo의 `benchmarks/reports/<timestamp>_<branch>_<sha>_jmh.json`에 보관

### 베이스라인 링크
- public mirror에는 벤치 하네스만 포함되고, 아카이브된 베이스라인 JSON은 private로 유지될 수 있습니다.
...
- 기준선 자동 발견은 canonical repo의 `benchmarks/reports/`를 전제로 합니다.
