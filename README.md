...
- **[v0.2.2 Release Notes](docs/dev/v0.2.2-release-notes.md)** — Latest published release notes and upgrade notes
...
Current downstream adoption work in this repository uses local `0.2.2` artifacts via `publishLocal`.
