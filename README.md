...
- The current bootstrap trust root remains the static validator set from `HotStuffBootstrapConfig.validatorSet`; historical validator-set rotation lookup, operator checkpoint / weak-subjectivity bootstrap material, and archive-grade backfill acceleration remain explicit follow-up work.
